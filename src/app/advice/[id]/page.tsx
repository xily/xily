    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8">
          <button
            onClick={() => router.back()}
            className="text-purpleBrand-accent hover:text-purpleBrand-accent mb-4 flex items-center"
          >
            ← Back
          </button>
          ...
          {session ? (
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-md">
              <p className="text-gray-600 text-sm">
                <a href="/auth" className="text-purpleBrand-accent hover:text-purpleBrand-accent">
                  Log in
